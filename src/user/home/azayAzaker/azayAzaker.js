...
import { faUsers, faVolumeUp, faCommentDots, faPenRuler } from "@fortawesome/free-solid-svg-icons";
...
function AzayAzaker() {
    ...
    return (
        <section className={styles.Azaylearning}>
            <div className="container">
                ...
                <div className={`${styles.cardcontainer}`}>
                    ...
                    <div className="col-sm-12 col-md-3">
                        <div className={`${styles.card}`}>
                            <FontAwesomeIcon icon={faCommentDots} style={{ fontSize: '40px' }} />
                            <h4>هتدرب</h4>
                            <p>علي امتحانات </p>
                        </div>
                    </div>
                ...
                <div data-aos="zoom-in"className={`${styles.learning}`}>
                    ...
                    <div className={`${styles.Containers}`}>
                        <div className={`${styles.col_sm_12} ${styles.col_md_4}`}>
                            <p className={`${styles.paragraph}`}>
                                يوجد اختبارات خاصة بالمواد لتدريب الطالب علي طرق الاسئلة المتنوعة وكيفيه التعامل معها لمواكبة طرق التعلم
                                يوجد اختبارات خاصة بالمواد لتدريب الطالب علي طرق الاسئلة المتنوعة وكيفيه التعامل معها لمواكبة طرق التعلم
                                يوجد اختبارات خاصة بالمواد لتدريب الطالب علي طرق الاسئلة المتنوعة وكيفيه التعامل معها لمواكبة طرق التعلم
                            </p>
                        </div>
                        <div className={`${styles.col_sm_12} ${styles.col_md_8}`}>
