                    ...
                    <div className="col-md-6 col-sm-12 d-flex flex-column align-items-center">
                        <div className={`${styles.container}`}>
                            ...
                            <div className={`${styles.left}`}>
                                <p className={`${styles.formHeading}`}>تواصل معنا</p>
                                <form className={`${styles.form}`}>
                                    ...
                                    <div className={`${styles.inputBlock}`}>
                                        <textarea
                                            ...
                                            cols={30}
                                            rows={3}
                                            className={`${styles.msgInput} ${styles.input}`}
                                        />
                                    </div>
                                    <button
                    ...
                    <div className={`${styles.card}`}>
                        <div className={`${styles.cardDetails}`}>
                            ...
                            <p className={`${styles.textBody}`}>
                                شكرا لتواصلك معنا سيتم الرد في اقرب وقت من خلال البريد
                                الالكتروني او رقم الهاتف
                            </p>
                        </div>
