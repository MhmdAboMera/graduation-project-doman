...
function AddClass() {
  ...
  const formSubmit = (e) => {
    ...
    selectInput.current.value = "اختر المرحلة الدراسية";
  };
  useEffect(() => {
    getAllClass();
    getAllStages();
            ...
            <div className="col-sm-12 col-lg-12">
              <div className="card card-info">
                <div className="card-header header-bg bg-success">
                  <h3 className="card-title header-title">اضافه صف دراسي</h3>
                </div>
            ...
            <div className="col-12">
              <div className="card">
                <div className="card-header bg-info">
                  <h3 className="card-title ">الصفوف الدراسية</h3>
